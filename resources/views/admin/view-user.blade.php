        ...
        <div class="profile-content">
            ...
            <div class="profile-photo-section">
                ...
                <div class="photo-actions">
                    <form action="{{ route('admin.update-user', $user->id) }}" method="POST" enctype="multipart/form-data" class="photo-upload-form">
                        @csrf
                        @method('PUT')
            ...
            <div class="profile-form-section">
                <form action="{{ route('admin.update-user', $user->id) }}" method="POST" class="profile-form">
                    @csrf
                    @method('PUT')
                    ...
                    @foreach($papers as $paper)
                        <div class="paper-card">
                            ...
                            <div class="paper-actions">
                                <a href="{{ route('admin.view-paper', $paper->id) }}" class="btn btn-outline">View Details</a>
